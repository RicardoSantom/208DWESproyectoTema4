...
<html lang="en">
    <head>
        ...
        <title>Mostrar ejercicio 04 PDO</title>
    </head>
    <body>
        <header>
        ...
        <main>
            <article>
                <h3>Libreria validacionFormularios.php</h3>
                 <?php highlight_file("../core/validacionFormularios.php") ?>
                <h3>Enunciado: Formulario de búsqueda de departamentos por descripción (por una parte del campo
                            DescDepartamento, si el usuario no pone nada deben aparecer todos los departamentos).</h3>
