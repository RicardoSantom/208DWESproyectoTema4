...
<html lang="en">
    <head>
        ...
        <title>Mostrar archivo inserción datos tabla</title>
    </head>
    <body>
        <header>
            <h1>Proyecto Tema 4</h1>
            <h2>Mostrar archivo inserción datos tabla</h2>
        </header>
        <main>
            <article>
                <h3>Código del archivo que ejecuta la inserción de datos en la tabla T02_Departamentos en DAW208DBDepartamentos.</h3>
                <?php highlight_file("../scriptDB/ejecutarInsercionTabla.php") ?>
            </article>
        </main>
        <footer>
