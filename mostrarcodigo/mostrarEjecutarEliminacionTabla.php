...
<html lang="en">
    <head>
        ...
        <title>Mostrar archivo eliminación DB y usuario</title>
    </head>
    <body>
        <header>
            <h1>Proyecto Tema 4</h1>
            <h2>Mostrar archivo eliminación DB  y usuario</h2>
        </header>
        <main>
            <article>
                <h3>Código del archivo que ejecuta la eliminación de base de datos y usuario.</h3>
                <?php highlight_file("../scriptDB/ejecutarEliminacionTabla.php") ?>
            </article>
        </main>
        <footer>
