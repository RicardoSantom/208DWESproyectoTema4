...
<html lang="en">
    <head>
        ...
        <title>Mostrar ejercicio 03 PDO</title>
    </head>
    <body>
        <header>
        ...
        <main>
            <article>
                ...
                <h3>Enunciado: Formulario para añadir un departamento a la tabla Departamento con validación de entrada y
                    control de errores.</h3>
                <?php highlight_file("../codigoPHP/ejercicio03.php") ?>
            </article>
        </main>
        <footer>
