...
<html lang="en">
    <head>
        ...
        <title>Mostrar ejercicio 06 PDO</title>
    </head>
    <body>
        <header>
        ...
        <main>
            <article><h3>Fichero conexión base de datos</h3>
                <?php highlight_file("../core/configuracionDB.php") ?>
                <h3>Enunciado: Página web que cargue registros en la tabla Departamento desde un array departamentosnuevos
