...
<html lang="en">
    <head>
        ...
        <title>Mostrar archivo creación tabla</title>
    </head>
    <body>
        <header>
            <h1>Proyecto Tema 4</h1>
            <h2>Mostrar archivo creacion tabla</h2>
        </header>
        <main>
            <article>
                <h3>Código del archivo que ejecuta la creación de tabla T02_Departamentos en DAW208DBDepartamentos.</h3>
                <?php highlight_file("../scriptDB/ejecutarCreacionTabla.php") ?>
            </article>
        </main>
        <footer>
